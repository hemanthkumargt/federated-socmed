...
export const setupPresentationData = async (req, res, next) => {
  try {
    ...
    // 1. Create Channels
    const channelsData = [
      { name: "Global", description: "The heartbeat of the network.", image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop" },
      { name: "Support", description: "Get help from the community.", image: "https://images.unsplash.com/photo-1521791136064-7986c2959d99?w=800&auto=format&fit=crop" }
    ];
    ...
    if (postCount < 3) {
      const posts = [
        { description: "Connected to the Federated Social Network!", user: createdUsers[0] },
        { description: "Testing the new social features. Looks amazing!", user: createdUsers[1] },
        { description: "Hello world from the Connect server!", user: createdUsers[2] }
      ];
